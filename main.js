...
function f2(hmname) {//меняет имя дома
    ...
    if((hmname != '') && (hmname.replace(/\s+/g,'') != 0) ){
    ...
    } else{document.getElementById("eds1").style.borderColor = 'red'; document.getElementById("btn").style.borderColor = 'red'}

}
function f3() { // меняет цвет input и btn обратно
    document.getElementById("eds1").style.borderColor = '';
