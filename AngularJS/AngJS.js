...
firstApp.controller('firstC', function firstC ($scope) {
    ...
    $scope.find = function () {
        ...
        for(let i = 0; i < $scope.home.length; i++){
            if($scope.home[i]._id === $scope.input) {return console.log($scope.home[i].homeName)}
        }
